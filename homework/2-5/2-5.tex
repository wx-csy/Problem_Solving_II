...
\begin{document}
  ...
  Let $S, C, T$ represent square, circle and triangle respectively. The sample space $S$ is $\{S, C, T\}^2$.  The event $E$, is $\{(S,S),(C,C),(T,T)\}$. The probability that the two shapes on the top are the same is
  $$ P(E) = P((S,S)) + P((C,C)) + P((T,T)) = \frac{1}{36} + \frac{1}{9} + \frac{1}{4} = \frac{7}{18} \approx 0.389 $$
